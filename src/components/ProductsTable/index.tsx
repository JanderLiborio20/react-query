...
async function fetchTable(page: number, perPage: number): Promise<IState> {
...
export const ProductsTable = () => {
  ...
  return (
    <Box pad="medium">
      <Heading level={2}>Lista de produtos {`${data?.text}`}</Heading>
